<?php
/**
 * gckid functions and definitions.
 *
...
if ( ! function_exists( 'gckid_setup' ) ) :
/**
 ...
 */
function gckid_setup() {
	/*
	 * Make theme available for translation.
	 * Translations can be filed in the /languages/ directory.
	 * If you're building a theme based on gckid, use a find and replace
	 * to change 'gckid' to the name of your theme in all the template files.
	 */
	...
	register_nav_menus( array(
		'primary' => esc_html__( 'Primary', 'gckid' ),
	) );
	...
	add_theme_support( 'custom-background', apply_filters( 'gckid_custom_background_args', array(
		'default-color' => 'ffffff',
		'default-image' => '',
	) ) );
}
endif;
add_action( 'after_setup_theme', 'gckid_setup' );
 ...
 */
function gckid_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'gckid_content_width', 640 );
}
add_action( 'after_setup_theme', 'gckid_content_width', 0 );
 ...
 */
function gckid_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'gckid' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'gckid' ),
    ...
    register_sidebar(
		array(
			'id' => 'footer-side 4', // уникальный id для сайта, назначается правому сайдбару
